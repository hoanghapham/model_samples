...
class TestFeedForwardNeuralNetwork(unittest.TestCase):
    ...
    def test_setters_getters(self):
        ...
        self.assertEqual(len(m1.theta_), (2+1)*3+(3+1), "Wrong number of parameters for the model")
        self.assertEqual(len(m2.theta_), (2+1)*4+(4+1), "Wrong number of parameters for the model")
    ...
    def test_fit(self):
        ...
        self.assertIsInstance(model, FeedForwardNeuralNetwork, 
